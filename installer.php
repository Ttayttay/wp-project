...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20241003_localproject_7260b6899beaa08f4557_20241024043520_archive.zip';
        const ARCHIVE_SIZE       = '45738175';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '7260b68-24043520';
        const SECONDARY_PACKAGE_HASH = '4df5e30-24043520';
